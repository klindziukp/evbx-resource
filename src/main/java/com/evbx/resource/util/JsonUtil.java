...
public final class JsonUtil {
  ...
  private static final String MODEL_MATCHING_ERROR_MESSAGE =
      "Parsing error: json structure doesn't match model.";
  ...
  static {
    ...
    mapper.setVisibility(
        mapper.getVisibilityChecker().withGetterVisibility(JsonAutoDetect.Visibility.NONE));
