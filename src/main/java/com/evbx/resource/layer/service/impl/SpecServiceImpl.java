...
public class SpecServiceImpl implements SpecService {
  ...
  @Override
  @Caching(
      put = {@CachePut(value = "specCache", key = "'specCache'+#specification.id")},
  ...
  @Override
  @Caching(
      put = {@CachePut(value = "specCache", key = "'spec'+#specification.id")},
      evict = {@CacheEvict(value = "allSpecsCache", allEntries = true)})
  ...
  @Caching(
      evict = {
        @CacheEvict(value = "specCache", key = "'specCache'+#id"),
