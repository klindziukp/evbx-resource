...
class IndustryReportControllerTest extends BaseControllerTest {
  ...
  void getReportTest() throws Exception {
    mockMvc
        .perform(get("/industry-reports/" + 100L).contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
  ...
  void getAllReportsTest() throws Exception {
    mockMvc
        .perform(get("/industry-reports").contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void getAllReportsIdsTest() throws Exception {
    mockMvc
        .perform(get("/industry-reports/ids").contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void deleteBookTest() throws Exception {
    mockMvc
        .perform(delete("/industry-reports/" + 102L).contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
