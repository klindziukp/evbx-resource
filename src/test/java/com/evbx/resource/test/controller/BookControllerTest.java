...
class BookControllerTest extends BaseControllerTest {
    ...
    void getBookTest() throws Exception {
        mockMvc.perform(get("/e-books/" + 100L)
    ...
    void getAllBooksIdsTest() throws Exception {
        mockMvc.perform(get("/e-books/ids")
                .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void updateBookTest() throws Exception {
        ...
        mockMvc.perform(patch("/e-books/" + 100L)
                .content(JsonUtil.toJson(mutationBook))
                .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    void deleteBookTest() throws Exception {
        mockMvc.perform(delete("/e-books/" + 102L)
                .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
