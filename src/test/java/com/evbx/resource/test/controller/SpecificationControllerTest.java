...
class SpecificationControllerTest extends BaseControllerTest {
  ...
  void getSpecificationTest() throws Exception {
    mockMvc
        .perform(get("/specifications/" + 100L).contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
  ...
  void getAllSpecificationsTest() throws Exception {
    mockMvc
        .perform(get("/specifications").contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void getAllSpecificationsIdsTest() throws Exception {
    mockMvc
        .perform(get("/specifications/ids").contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void deleteBookTest() throws Exception {
    mockMvc
        .perform(delete("/specifications/" + 102L).contentType(MediaType.APPLICATION_JSON_VALUE))
        .andDo(print())
        .andExpect(status().isOk())
