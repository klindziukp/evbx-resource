...
public class BookRepositoryTest extends BaseRepositoryTest {
    ...
    void findBookByIdTest() {
        ...
        Book actualBook = bookRepository.findById(id).orElseThrow(() -> new ItemNotFoundException(Item.E_BOOK, id));
        __THEN();
    ...
    void saveBookTest() {
        ...
        Book extractedBook = bookRepository.findById(id).orElseThrow(() -> new ItemNotFoundException(Item.E_BOOK, id));
        __THEN();
    ...
    void getBookNamesProjectionTest() {
        __GIVEN();
        List<NameProjection> expectedBookNameProjections = TestDataProjectionStorage.getBookNameProjections();
        __WHEN();
        List<NameProjection> actualBookNameProjections = bookRepository.getNames();
        __THEN();
        projectionVerificationService.verifyNameProjections(actualBookNameProjections, expectedBookNameProjections);
    }
