...
public class ReportRepositoryTest extends BaseRepositoryTest {
    ...
    void findIndustryReportByIdTest() {
        ...
        IndustryReport actualIndustryReport = reportRepository.findById(id).orElseThrow(
    ...
    void saveIndustryReportTest() {
        ...
        IndustryReport extractedIndustryReport = reportRepository.findById(id).orElseThrow(
                () -> new ItemNotFoundException(Item.INDUSTRY_REPORT, id));
        __THEN();
    ...
    void getIndustryReportNamesProjectionTest() {
        __GIVEN();
        List<NameProjection> expectedIndustryReportNameProjections = TestDataProjectionStorage.getIndustryReportNameProjections();
        __WHEN();
        List<NameProjection> actualIndustryReportNameProjections = reportRepository.getNames();
        __THEN();
        projectionVerificationService.verifyNameProjections(actualIndustryReportNameProjections,
                expectedIndustryReportNameProjections);
    }
