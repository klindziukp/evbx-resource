...
public class SpecRepositoryTest extends BaseRepositoryTest {
    ...
    void findSpecificationByIdTest() {
        ...
        Specification actualSpecification = specRepository.findById(id).orElseThrow(
    ...
    void saveSpecificationTest() {
        ...
        Specification extractedSpecification = specRepository.findById(id).orElseThrow(
                () -> new ItemNotFoundException(Item.SPECIFICATION, id));
        __THEN();
    ...
    void getSpecificationNamesProjectionTest() {
        __GIVEN();
        List<NameProjection> expectedSpecificationNameProjections = TestDataProjectionStorage.getSpecNameProjections();
        __WHEN();
        List<NameProjection> actualSpecificationNameProjections = specRepository.getNames();
        __THEN();
        projectionVerificationService.verifyNameProjections(actualSpecificationNameProjections,
                expectedSpecificationNameProjections);
    }
