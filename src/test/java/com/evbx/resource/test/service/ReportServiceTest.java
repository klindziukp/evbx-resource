...
class ReportServiceTest extends BaseServiceTest {
  ...
  void getAllIdsIndustryReportTest() {
    ...
    List<Long> expectedIds =
        TestDataStorage.getIdsFromList(TestDataStorage.getTestIndustryReports());
    __WHEN();
  ...
  void itemNotFoundExceptionGetTest() {
    ...
    Assertions.assertThrows(
        ItemNotFoundException.class, () -> reportService.findById(nonPresentId));
  }
  ...
  void itemNotFoundExceptionDeleteTest() {
    ...
    __THEN();
    Assertions.assertThrows(
        ItemNotFoundException.class, () -> reportService.deleteById(nonPresentId));
  }
}
